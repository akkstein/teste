...
public:
    ...
    * \remarks Changes to this value may occur at anytime due to network or moderator events.
    *  It is not safe to join this user to another channel, or rejoin this channel, while this
    *  property is in the ConnectionState::Disconnecting state, UNLESS another IChannelSession
    *  is already Connected. If not connected to another channel, calls to BeginConnect() for
    ...
    */
    ...
    /**
    * \brief This event is fired when the channel connection state changes
    */
     ...
     *
     * \remarks You should not try to join this user to another channel, or rejoin this channel, while this session's ChannelState()
     ...
     *  calling BeginConnect() again. This object will remain in the ILoginSession::ChannelSessions() list in the disconnected state.
